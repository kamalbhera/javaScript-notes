...
// ex -> settimeour and setInterval in which if two functions then both run parally 
...
function clock(){
    let d = new Date();
    document.querySelector(".clock").innerHTML = d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds() +":"+d.getMilliseconds()
}
